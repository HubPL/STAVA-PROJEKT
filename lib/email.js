      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-content">
            ...
            <p>Dziękujemy za złożenie prośby o rezerwację w STAVA!</p>
...
function generateStatusUpdateHTML(rezerwacja, newStatus) {
  ...
  if (rezerwacja.selectedDomki && Array.isArray(rezerwacja.selectedDomki)) {
    ...
    // Treść dla rezerwacji potwierdzonej
    const confirmedContent = isConfirmed ? (
      '<div class="content-section total-cost-section">' +
        '<h3>Szczegóły rezerwacji</h3>' +
        domkiListHTML +
    ...
    // Treść dla starej struktury
    const confirmedContentOld = isConfirmed ? (
      '<div class="content-section total-cost-section">' +
        '<h3>Podsumowanie rezerwacji</h3>' +
