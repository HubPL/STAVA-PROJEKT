      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-content">
            ...
            <p>Oto podsumowanie Twojej rezerwacji:</p>
            ...
            <div class="content-section warning">
              ...
              <p>Prosimy o dokonanie wpłaty w ciągu <strong>24 godzin</strong> od momentu otrzymania potwierdzenia.</p>
              <p><strong>W przypadku braku wpłaty rezerwacja zostanie automatycznie anulowana.</strong></p>
            </div>
        ...
        <div class="email-container">
          ...
          <div class="email-content">
            ...
            <div class="content-section ${isConfirmed ? 'success' : 'error'}">
              ...
              <p>Twoja rezerwacja ${rezerwacja.selectedDomki.length} ${rezerwacja.selectedDomki.length === 1 ? 'domku' : 'domków'} została: <span class="status-badge ${isConfirmed ? 'success' : 'error'}">${statusText}</span></p>
            </div>
            ...
            ` : `
              ...
              <div class="content-section success">
                ...
                • Rozważ rezerwację mniejszej liczby domków jeśli część terminów jest dostępna<br/>
                • Zapisz się na listę powiadomień o wolnych terminach</p>
              </div>
              
              <p>Przepraszamy za niedogodności i bardzo mamy nadzieję, że uda nam się gościć Cię w przyszłości.</p>
            `}
          </div>
        ...
        <div class="email-container">
          ...
          <div class="email-content">
            ...
            ${isConfirmed ? `
              <div class="content-section total-cost-section">
                <h3>Szczegóły rezerwacji</h3>
                <p><strong>Domek:</strong> ${rezerwacja.domekNazwa || rezerwacja.domekId ? rezerwacja.domekId.replace('D', '') : 'Do przydzielenia'}</p>
                <p><strong>Przyjazd:</strong> ${startDate}</p>
                <p><strong>Wyjazd:</strong> ${endDate}</p>
                <p><strong>Liczba osób:</strong> ${rezerwacja.liczbOsob}</p>
                <p><strong>Liczba nocy:</strong> ${rezerwacja.iloscNocy}</p>
