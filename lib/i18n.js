...
const translations = {
  pl: {
    ...
    'home.stava_description': 'STAVA TO DOMY WYPOCZYNKOWE CAŁOROCZNE O WYSOKIM\nSTANDARDZIE, SCHOWANE W CIENIU DRZEW - Z DALA OD\nMIEJSKIEGO ZGIEŁKU.',
    'home.where_find': 'GDZIE NAS ZNALEŹĆ?',
    'home.location_description': 'OŚRODEK MIEŚCI SIĘ W LESIE NIEDALEKO MIEJSCOWOŚCI\nSTARA KISZEWA, NA POGRANICZU POJEZIERZA\nKASZUBSKIEGO I BORÓW TUCHOLSKICH W DOLINIE RZEKI\nWIEŻYCY.',
    'home.what_awaits': 'CO CIĘ U NAS CZEKA?',
    'home.experience_description': 'WYPOCZYNEK W OTOCZENIU DRZEW I ŚPIEWAJĄCYCH PTAKÓW\nW BEZPOŚREDNIEJ BLISKOŚCI Z NATURĄ.\nLICZNE SZLAKI PIESZE I ROWEROWE WŚRÓD MALOWNICZYCH ŁĄK LASÓW I JEZIOR.',
    'home.about_us': 'O NAS',
    ...
    'cottages.living_room_desc': 'rozkładana sofa, kominek, stół jadalny dla 4 osób, TV (smart tv), Wi-Fi, klimatyzacja z funkcją grzania',
    'cottages.kitchen_desc': 'pełne wyposażenie: duża lodówka, mikrofalówka, zmywarka, piekarnik, toster, płyta indukcyjna, ciśnieniowy ekspres do kawy, czajnik elektryczny, kawa, herbata, komplet naczyń, garnków i sztućców dla 6 osób',
    'cottages.bathroom_desc': 'prysznic, ręczniki i szlafroki dla 4-6 osób, kosmetyki: mydło i żel pod prysznic, suszarka do włosów',
    'cottages.bedroom1_desc': 'dwuosobowa, możliwość ustawienia łóżek pojedynczych lub małżeńskiego, komplet pościeli, klimatyzacja z funkcją grzania',
    'cottages.bedroom2_desc': 'dwuosobowa z miejscem do pracy/toaletką, możliwość ustawienia łóżek pojedynczych lub małżeńskiego, komplet pościeli, klimatyzacja z funkcją grzania',
    ...
    'cottages.min_stay': 'Minimalny pobyt: {nights} doby',
    'cottages.cottage_name': 'Domy wypoczynkowe',
    'cottages.from_4_people': '4 osoby (opcja do 6 osób - rozkładana sofa, dodatkowa opłata za każdą osobę)',
    ...
    'cottages.smoking_policy': 'Całkowity zakaz palenia na terenie ośrodka (tylko w wyznaczonych miejscach)',
