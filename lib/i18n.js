...
const translations = {
  pl: {
    ...
    'cottages.living_room_desc': 'rozkładana sofa, stół dla 4 osób, TV (smart tv), kominek',
    'cottages.kitchen_desc': 'pełne wyposażenie',
    'cottages.bathroom_desc': 'prysznic, ręczniki i szlafroki dla 4-6 osób, suszarka do włosów',
    'cottages.bedroom1_desc': 'dwuosobowa, możliwość ustawienia łóżek pojedynczych lub małżeńskiego',
    'cottages.bedroom2_desc': 'dwuosobowa z miejscem do pracy/toaletką, możliwość ustawienia łóżek pojedynczych lub małżeńskiego',
    ...
    'cottages.cottage_name': 'Domek wypoczynkowy',
    'cottages.from_4_people': '4 osoby (opcja do 6 osób - rozkładana sofa, dodatkowa opłata za każdą osobę)',
    'cottages.pets_info': 'Informacja dostępna po kontakcie',
    'cottages.smoking_policy': 'Całkowity zakaz palenia wewnątrz domku',
  ...
  en: {
    ...
    'cottages.living_room_desc': 'foldable sofa, table for 4 people, TV (smart tv), fireplace',
    'cottages.kitchen_desc': 'fully equipped',
    'cottages.bathroom_desc': 'shower, towels and bathrobes for 4-6 people, hair dryer',
    'cottages.bedroom1_desc': 'double bed, possibility to arrange single beds or double bed',
    'cottages.bedroom2_desc': 'double bed with workspace/dressing table, possibility to arrange single beds or double bed',
    ...
    'cottages.cottage_name': 'Recreation Cottage',
    'cottages.from_4_people': '4 people (option up to 6 people - foldable sofa, additional charge for each extra person)',
    'cottages.pets_info': 'Information available upon contact',
    'cottages.smoking_policy': 'Completely prohibited smoking inside the cottage',
