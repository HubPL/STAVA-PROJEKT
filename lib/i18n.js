...
const translations = {
  pl: {
    ...
    'home.experience_description': 'MOŻESZ CIESZYĆ SIĘ OTACZAJĄCYM LASEM, POBLISKIMI JEZIORAMI.\nZANURZYĆ SIĘ W BALII POŚRÓD DRZEW ALBO\nWYGRZAĆ W PRYWATNEJ SAUNIE Z WIDOKIEM NA LAS.',
    'home.about_us': 'O NAS',
    'home.gallery_photos': 'GALERIA ZDJĘĆ',
    'home.write_to_us': 'Napisz do nas',
    'home.write_subtitle': 'Masz pytania? Chętnie na nie odpowiemy.',
    'home.our_data': 'Nasze dane',
    ...
    'gallery.subtitle': 'Odkryj piękno STAVA przez nasze zdjęcia. Każdy obraz opowiada historię\nspokoju i harmonii z naturą.',
  ...
  en: {
    ...
    'home.experience_description': 'YOU CAN ENJOY THE SURROUNDING FOREST, NEARBY LAKES.\nIMMERSE YOURSELF IN A TUB AMONG THE TREES OR\nWARM UP IN A PRIVATE SAUNA WITH A FOREST VIEW.',
    ...
    'gallery.subtitle': 'Discover the beauty of STAVA through our photos. Each image tells a story\nof peace and harmony with nature.',
