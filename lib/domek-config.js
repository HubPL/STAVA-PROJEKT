...
export const DOMEK_INFO = {
  ...
  uklad: {
    ...
    szczegoly: {
      parter: {
        salon: "rozkładana sofa, stół dla 4 osób, TV (smart tv), kominek",
        kuchnia: "pełne wyposażenie",
        lazienka: "prysznic, ręczniki i szlafroki dla 4-6 osób, suszarka do włosów"
      },
      pietro: {
        sypialnia1: "dwuosobowa, możliwość ustawienia łóżek pojedynczych lub małżeńskiego",
        sypialnia2: "dwuosobowa z miejscem do pracy/toaletką, możliwość ustawienia łóżek pojedynczych lub małżeńskiego"
      }
    }
  },
