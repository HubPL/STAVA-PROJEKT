...
export const verifyOrigin = (request) => {
  ...
  const allowedOrigins = [
    ...
    'http://localhost:3001',
    'https://stava-tin.vercel.app', // domena Vercel
    'https://stava-tin-git-main.vercel.app', // alternatywna domena Vercel
  ];
  
  // Dodatkowo sprawdź czy to domena .vercel.app
  const isVercelDomain = origin && origin.includes('.vercel.app');
  
  return !origin || allowedOrigins.includes(origin) || isVercelDomain;
}; 